...
define(function(require) {
    ...
    /** 
     * This constant defines the minimum number of pixels beyond a boundary a scroll event
     * must reach for boundary events to be fired, so that light touches and small scrolls 
     * (by default) wont fire events constantly.  This sensetivity is configurable when
     * initializing the BoundaryInterceptor, else it will use this by default.  A value of
     * 0 will cause every event which passes a boundary to fire a boundary event.
     * @type {number}
     */
    ...
    var BoundaryInterceptor = function(options) {
        ...
        /**
         * This value defines the minimum number of pixels beyond a boundary a scroll event
         * must reach for boundary events to be fired, so that light touches and small scrolls 
